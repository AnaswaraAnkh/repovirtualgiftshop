    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('DEACTIVE', 'Inactive')], max_length=20, null=True)),
                ('is_active', models.CharField(blank=True, default=True, max_length=20, null=True)),
                ('user_type', models.CharField(choices=[('Shop', 'shop'), ('USER', 'user'), ('Admin', 'admin')], max_length=20, null=True)),
